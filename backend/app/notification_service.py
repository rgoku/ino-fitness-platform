...
class InAppNotification(NotificationChannel):
    ...
    async def send(self, user_id: str, title: str, message: str, data: dict = None) -> dict:
        """Create an in-app message (handled by caller; this is a marker)."""
        return {
            "success": True,
            "channel": "in-app",
...
class PushNotification(NotificationChannel):
    ...
    async def send(self, user_id: str, title: str, message: str, data: dict = None) -> dict:
        ...
        try:
            ...
            # In production, retrieve user's FCM token from database
            # This is a stub; you'd query the User or a UserDevices table
            ...
            response = requests.post(self.fcm_endpoint, json=payload, headers=headers, timeout=5)
...
class EmailNotification(NotificationChannel):
    ...
    async def send(self, user_id: str, title: str, message: str, data: dict = None) -> dict:
        ...
        try:
            # In production, retrieve user email from database
...
class NotificationService:
    ...
    async def send(self, channel: str, user_id: str, title: str, message: str, data: dict = None) -> dict:
    ...
    async def send_multi(self, channels: list, user_id: str, title: str, message: str, data: dict = None) -> dict:
