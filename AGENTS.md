# INÖ Fitness Platform — Codex Configuration
...
- **AI:** Anthropic Codex API + MediaPipe (pose detection)
- **Payments:** Stripe
...
- **everything-Codex** — Agents, skills, hooks, security scanning
- **Codex-mem** — Persistent memory across sessions
