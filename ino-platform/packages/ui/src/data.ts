...
export const PLANS = [
  {
    id: 'starter', name: 'Starter', price: 129, period: '/mo', popular: false,
    desc: 'Everything you need to coach professionally',
    clients: '20 clients',
    features: [
      'Workout Builder & Templates', 'Exercise Video Library', 'Client Messaging',
      'Progress Photo Tracking', 'Basic Check-ins', 'Nutrition Guidelines',
    ],
  ...
  },
  {
    ...
    clients: '50 clients',
    features: [
      'Everything in Starter', 'Smart Automation Workflows', 'Advanced Check-in System',
      'Client Risk Flags & Alerts', 'Readiness Scoring', 'Custom Branding',
      'Form Video Review', 'Form review videos stored 90 days (rolling)', 'Priority Email Support',
    ],
    missing: ['Deep Automation', 'Team Access'],
  },
  {
    id: 'scale', name: 'Scale', price: 399, period: '/mo', popular: false,
    desc: 'For coaching teams running a real operation',
    clients: '100+ clients',
    features: [
      'Everything in Pro', 'Deep Automation Engine', 'Staff Roles (Coach / Assistant / Admin)',
      'Shared Inbox & Assignment Ownership', 'Advanced Client Analytics', 'White-label Branding',
      'Dedicated Account Manager', 'Priority Phone & Chat Support', 'API Access',
    ],
    missing: [],
  },
];
...
export const FEATURES = [
  ...
  { icon: 'zap', color: T.warning, title: 'Smart Automation',
    desc: 'Client misses 2 workouts → auto-send check-in → flag coach after 48h. Set rules once, let them run. No manual follow-up.' },
  { icon: 'heartPulse', color: T.success, title: 'Readiness & Check-ins',
    desc: 'Daily readiness scores, weekly check-ins, and progress photo tracking — all synced to the coach dashboard.' },
  { icon: 'chart', color: T.cyan, title: 'Analytics Dashboard',
    desc: 'Client adherence trends, revenue tracking, retention rates, and business performance — all in one view.' },
];

export const TESTIMONIALS = [
  { name: 'Marcus Rivera', role: 'Online Strength Coach', initials: 'MR', color: T.primary,
    quote: 'Went from 18 to 62 clients in 4 months. The automation handles what used to take me 3 hours a day.', metric: '18 → 62 clients' },
  { name: 'Jenna Kowalski', role: 'Nutrition & Fitness Coach', initials: 'JK', color: T.pink,
    quote: 'My clients love the app. Check-in completion went from maybe 40% to over 90%. It changed my entire business.', metric: '90% check-in rate' },
  { name: 'David Okonkwo', role: 'Gym Owner & Head Coach', initials: 'DO', color: T.cyan,
    quote: "We run 100+ online clients alongside our gym. INÖ is the only platform that didn't break at scale.", metric: '100+ clients managed' },
];
...
export const DEMO_MEMBERS = [
  { id: 'm1', name: 'James Wilson', initials: 'JW', status: 'active' as const, progress: 0.84, streak: 12, lastActive: 'Today' },
  { id: 'm2', name: 'Emma Davis', initials: 'ED', status: 'active' as const, progress: 0.92, streak: 28, lastActive: 'Today' },
  { id: 'm3', name: 'Mike Chen', initials: 'MC', status: 'at_risk' as const, progress: 0.45, streak: 0, lastActive: '3 days ago' },
  { id: 'm4', name: 'Lisa Park', initials: 'LP', status: 'active' as const, progress: 0.78, streak: 7, lastActive: 'Yesterday' },
];
